...
void main() {
  group('EventModell Tests', () {
    test('EventModell instantiation', () {
      ...
      expect(event.note, 'Discuss project updates');
      expect(event.recurrenceRule, 'FREQ=DAILY;COUNT=10');
    });

    test('EventModell copyWith', () {
      final event = EventModel(
        id: '1',
        startTime: DateTime(2023, 10, 1, 10, 0),
        endTime: DateTime(2023, 10, 1, 12, 0),
    ...
    test('EventModell toMap and fromMap', () {
      final event = EventModel(
        id: '1',
        startTime: DateTime(2023, 10, 1, 10, 0),
        endTime: DateTime(2023, 10, 1, 12, 0),
    ...
    test('EventModell toJson and fromJson', () {
      final event = EventModel(
        id: '2',
    ...
    test('EventModell formatted time strings', () {
      final event = EventModel(
